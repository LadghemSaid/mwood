...
<div class="col span_4">
	...
	<div class="cart-collaterals">
		...
		<input type="submit" class="button" name="update_cart" value="<?php esc_attr_e( 'Update Cart', 'woocommerce' ); ?>" /> <input type="submit" class="checkout-button button alt wc-forward" name="proceed" value="<?php esc_attr_e( 'Proceed to Checkout', 'woocommerce' ); ?>" />

...
class IS_Help {
	...
	private function content( $name ) {
		...
		$content['list_available_actions'] .= '<p>' . __( "<strong>Edit</strong> - Navigates to the editing screen for that search form. You can also reach that screen by clicking on the search form title.", 'add-search-to-menu' ) . '</p>';
		$content['list_available_actions'] .= '<p>' . __( "<strong>Duplicate</strong> - Clones that search form. A cloned search form inherits all content from the original, but has a different ID.", 'add-search-to-menu' ) . '</p>';
		$content['list_available_actions'] .= '<p>' . __( "<strong>Delete</strong> - Deletes the search form. The search form gets deleted permanently and its shortcode becomes void so you have to remove the shortcode if you have used it anywhere.", 'add-search-to-menu' ) . '</p>';
		...
		$content['edit_overview'] .= '<p>' . __( "<strong>Title</strong> is the title of a search form. This title is only used for labeling a search form, and can be edited.", 'add-search-to-menu' ) . '</p>';
		$content['edit_overview'] .= '<p>' . __( "<strong>Includes</strong> provides options to control which content on the site is searchable.", 'add-search-to-menu' ) . '</p>';
		$content['edit_overview'] .= '<p>' . __( "<strong>Excludes</strong> provides options to exclude specific content from the search on the site.", 'add-search-to-menu' ) . '</p>';
		$content['edit_overview'] .= '<p>' . __( "<strong>Options</strong> provides a place where you can customize overall behavior of this search form.", 'add-search-to-menu' ) . '</p>';
		...
		$content['settings_overview'] .= '<p>' . __( "<strong>Menu Search</strong> provides a place where you can customize the behavior of search form added in the site navgation menu.", 'add-search-to-menu' ) . '</p>';
		$content['settings_overview'] .= '<p>' . __( "<strong>Settings</strong> provides options to configure sitewide search functionality.", 'add-search-to-menu' ) . '</p>';
